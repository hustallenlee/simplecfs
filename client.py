...
from simplecfs.message.packet import AddChunkPacket
from simplecfs.common.network_handler import send_command, recv_command,\
    send_data
...
def get_new_connection(ip='127.0.0.1', port=7000):
    return eventlet.connect((ip, port))
